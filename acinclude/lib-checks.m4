...
AC_DEFUN([SQUID_CHECK_LIBCRYPTO_API],[
  ...
  AH_TEMPLATE(HAVE_LIBCRYPTO_EVP_PKEY_IS_A, "Define to 1 if the EVP_PKEY_is_a() OpenSSL API function exists")
  ...
  AC_CHECK_LIB(crypto, EVP_PKEY_is_a, AC_DEFINE(HAVE_LIBCRYPTO_EVP_PKEY_IS_A, 1))

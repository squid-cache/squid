...
AC_DEFUN([SQUID_CHECK_LIBCRYPTO_API],[
  ...
  AH_TEMPLATE(HAVE_LIBCRYPTO_ASN1_TIME_COMPARE, "Define to 1 if the ASN1_TIME_compare() OpenSSL API function exists")
  ...
  AC_CHECK_LIB(crypto, ASN1_TIME_compare, AC_DEFINE(HAVE_LIBCRYPTO_ASN1_TIME_COMPARE, 1))

...
#ifndef SQUID_SRC_STORE_FS_ROCK_ROCKSTOREFILESYSTEM_H
#define SQUID_SRC_STORE_FS_ROCK_ROCKSTOREFILESYSTEM_H
...
#endif /* SQUID_SRC_STORE_FS_ROCK_ROCKSTOREFILESYSTEM_H */

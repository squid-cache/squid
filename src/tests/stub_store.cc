...
void StoreEntry::getPublicByRequestMethod(StoreClient * aClient, HttpRequest * request, const HttpRequestMethod& method, ACLFilledChecklist *) STUB
void StoreEntry::getPublicByRequest(StoreClient * aClient, HttpRequest * request, ACLFilledChecklist *) STUB
void StoreEntry::getPublic(StoreClient * aClient, const char *uri, const HttpRequestMethod& method, ACLFilledChecklist *) STUB

...
TestHttp1Parser::testParserConstruct()
{
    // whether the constructor works
    {
        ...
        CPPUNIT_ASSERT_EQUAL(Http::RequestMethod(Http::METHOD_NONE), output.method_);
...
TestHttp1Parser::testParseRequestLineProtocols()
{
    ...
    // RFC 1945 : HTTP/0.9 simple-request
    {
        ...
        struct resultSet expect = {
            ...
            .status = Http::scOkay,
            .suffixSz = 0,
            .method = Http::RequestMethod(Http::METHOD_GET),
            .uri = "/",
    ...
    // RFC 1945 : invalid HTTP/0.9 simple-request (only GET is valid)
    {
        ...
        struct resultSet expect = {
            ...
            .method = Http::RequestMethod(Http::METHOD_POST),
            .uri = nullptr,
...
TestHttp1Parser::testParseRequestLineMethods()
{
    ...
    // RFC 7230 : dot method
    {
        ...
        struct resultSet expect = {
            ...
            .status = Http::scOkay,
            .suffixSz = 0,
            .method = Http::RequestMethod(SBuf(".")),
            .uri = "/",
            .version = AnyP::ProtocolVersion(AnyP::PROTO_HTTP,1,1)
        };
        output.clear();
    ...
    // RFC 7230 : special TCHAR method chars
    {
        ...
        struct resultSet expect = {
            ...
            .status = Http::scOkay,
            .suffixSz = 0,
            .method = Http::RequestMethod(SBuf("!#$%&'*+-.^_`|~")),
            .uri = "/",
            .version = AnyP::ProtocolVersion(AnyP::PROTO_HTTP,1,1)
        };
        output.clear();
    ...
    // OPTIONS with * URL
    {
        ...
        struct resultSet expect = {
            ...
            .status = Http::scOkay,
            .suffixSz = 0,
            .method = Http::RequestMethod(Http::METHOD_OPTIONS),
            .uri = "*",
            .version = AnyP::ProtocolVersion(AnyP::PROTO_HTTP,1,1)
        };
        output.clear();
    ...
    // unknown method
    {
        ...
        struct resultSet expect = {
            ...
            .status = Http::scOkay,
            .suffixSz = 0,
            .method = Http::RequestMethod(SBuf("HELLOWORLD")),
            .uri = "/",
            .version = AnyP::ProtocolVersion(AnyP::PROTO_HTTP,1,1)
        };
        output.clear();
    ...
    do {
        ...
        for (SBuf::size_type pos = 0; pos <= data.length(); ++pos) {
            ...
            if (pos == reqLineEnd) {
                ...
                expect.method = Http::RequestMethod(Http::METHOD_GET);

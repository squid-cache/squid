...
bool HttpReply::expectingBody(const Http::RequestMethod&, int64_t&) const STUB_RETVAL(false)
...
int64_t HttpReply::bodySize(const Http::RequestMethod&) const STUB_RETVAL(0)
